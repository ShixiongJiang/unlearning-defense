...
python eval_cdt.py --path logs/OfflineCarCircle-v0-cost-10/CDT-84de/CDT-84de --eval_episodes 20

eval the poisoned BCQL model:
python eval_cdt.py --path logs/OfflineCarCircle-v0-cost-10/CDT_poisoned_maxcost-87ba/CDT_poisoned_maxcost-87ba --eval_episodes 20
'''
